    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10 '>
          ...
          {/* Product info */}
          <div className="lg:col-span-1 max-auto max-w-2x1 px-4 pb-16 sm:px-6 lg:max-w-7x1 lg:px-8
          lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-x1 font-semibold text-gray-900">
                {products.products?.brand}
              </h1>
              <h1 className="text-lg lg:text-x1text-gray-900 opacity-70 pt-1">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-50 text-sm'>54540 rating</p>
                  <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>2323 review</p>
                </div>
              </div>
              ...
              <form className="mt-10">
                ...
                <Button onClick={handleAddToCart} variant='contained' sx={{ px: "2rem", py: "1rem", bgcolor: "#ba0fa6" }}>
                  Add to Cart
                </Button>
              </form>
            </div>
        ...
        {/* rating and reviews */}
        <section>
          <h1 className='font-semibold text-lg pb-4 ml-5'>Nhận xét và đánh giá</h1>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={7}>
                <div className='space-y-5'>
                  {[1, 1, 1, 1].map(item => <ProductReviewCards />)}
                </div>
              </Grid>
              ...
              <Grid item xs={5}>
                ...
                <div className='flex items-center space-x-3'>
                  <Rating name='read-only' value={4.6} precision={.5}></Rating>
                  <p className='opacity-60'>54000 ratings</p>
                </div>
                ...
                <Box className='mt-5 space-y-3'>
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{ bgcolor: "#8d899c", borderRadius: 4, height: 7 }}
                  ...
                  <Grid container alignItems="center" gap={2}>
                    ...
                    <Grid item xs={7}>
                      <LinearProgress sx={{ bgcolor: "#8d899c", borderRadius: 4, height: 7, color: "yellow-300" }}
