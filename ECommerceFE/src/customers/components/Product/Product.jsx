...
export default function Product() {
  ...
  const location = useLocation() // Lấy ra URL hiện tại
  const navigate = useNavigate() // Thực hiện điều hướng mà k cần reload lại trang
  ...
  // Thực hiện lọc giá trị trên URL (Của Color va Size)
      ...
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">VQ Store</h1>
