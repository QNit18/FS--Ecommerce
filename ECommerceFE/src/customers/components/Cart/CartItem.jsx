    ...
    <div className='p-5 shadow-lg border rounded-md mt-2'>
      <div className='flex items-center'>
        ...
        <div className='ml-5 space-y-1'>
          ...
          <p className='opacity-70'>Size: {item.size}, <b>{item.product.color}</b></p>
      ...
      <div className='lg:flex items-center lg:space-x-10 pt-4'>
        ...
        <div className='flex items-center space-x-2'>
          ...
          <IconButton onClick={() => handleUpdateCartItem(1)} sx={{color:'#1d0be0'}}>
            <AddCircleOutlineIcon />
          </IconButton>
        </div>
        <div>
          <Button onClick={handleRemoveCartItem} sx={{color:'#1d0be0'}}>remove</Button>
        </div>
      </div>
